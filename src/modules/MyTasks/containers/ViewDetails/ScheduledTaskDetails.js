...
import ManageTaskDetail from '../../components/Manage/ScheduleTaskDetails';
import { ROUTE_TASKS } from '../../constantsRoute';

class ScheduledTaskDetails extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidUpdate() {
    ...
    if (!isFetchingMTTaskDetails) {
      ...
      if (taskDetails?.status !== TASK_STATUS.SCHEDULED) {
      ...
      <>
        ...
        {isEmpty(taskDetails) ? (
          ...
          <DetailContent>
            ...
            <ManageTaskDetail taskDetails={taskDetails} />
          </DetailContent>
        )}
      </>
    );
...
ScheduledTaskDetails.propTypes = {
  t: PropTypes.func,
